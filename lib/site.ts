...
export const DEFAULT_SEO_KEYWORDS = [
  ...
  "whatsapp bulk sender software india",
  "whatsapp crm automation tool",
  "150000 lightroom presets bundle",
  "wedding planner templates pack",
  "30000 fonts collection download",
  "6000 kids worksheets printable pdf",
  "iit jee neet preparation materials pdf",
  "300 elementor landing page templates",
  "claude ai skills prompt pack",
  "dfy sales email marketing templates",
  "ebooks india",
