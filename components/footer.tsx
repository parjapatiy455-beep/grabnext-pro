                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <div className="flex flex-col gap-2 mt-4">
                            <div className="flex items-center gap-3">
                                <a
                                    href="https://www.facebook.com/GrabNextofficial"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="Facebook"
                                    className="h-9 w-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors text-white shadow-md hover:scale-105"
                                >
                                ...
                                <a
                                    href="https://www.instagram.com/grabnextofficial/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="Instagram"
                                    className="h-9 w-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-gradient-to-tr hover:from-amber-500 hover:via-pink-600 hover:to-purple-600 transition-all text-white shadow-md hover:scale-105"
                                >
                                    <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
                                ...
                                <a
                                    href="https://wa.me/917500167987"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="WhatsApp"
                                    className="h-9 w-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-emerald-600 transition-colors text-white shadow-md hover:scale-105"
                                >
                                    <svg className="w-4.5 h-4.5 fill-current text-emerald-400 hover:text-white" viewBox="0 0 24 24">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-xs text-gray-400 hover:text-emerald-400 transition-colors flex items-center gap-1.5 font-medium mt-1"
                            >
                                <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></span>
                                <span>WhatsApp: +91 75001 67987</span>
                            </a>
                        </div>
                    </div>
