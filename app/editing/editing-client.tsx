...
import { ChevronDown, MessageSquare, ShieldCheck, CheckCircle2, Play, Volume2, VolumeX, Clock, Lock, Shield, Zap, Sparkles, Copy, Check, X, Gift, Tag } from "lucide-react"
...
export function EditingLandingPageClient() {
  ...
  return (
    <div className="bg-[#0b0c15] text-slate-100 font-sans min-h-screen selection:bg-violet-600 selection:text-white overflow-x-hidden">
      ...
      {/* 50% OFF PROMO MODAL (Appears after 5 seconds of stay) */}
      {showPromoModal && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-300">
          <div className="relative w-full max-w-md bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border-2 border-amber-500/40 rounded-3xl p-6 shadow-[0_0_50px_rgba(245,158,11,0.3)] text-center overflow-hidden">
